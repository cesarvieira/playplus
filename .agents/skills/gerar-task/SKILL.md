...
## Metadados sugeridos _(não copiar tabela para o corpo da issue)_
...
_Análise baseada em: [código local / inferência de domínio]_
```
...
## Metadados sugeridos _(somente chat)_
