...
**Tema visual:** toda UI admin deve seguir [`apps/admin/docs/theme.md`](../../../apps/admin/docs/theme.md) — tokens `peach-*`/`status-*`, escalas `text-pl-*`, classes compostas `pl-*`. Na revisão UX, sinalize desvios (`text-sm`, hex, `size-12`, utilitários copiados entre telas).
